...
//! [`stoa_inject_hooks::run`], and writes the `hookSpecificOutput` JSON
//! to stdout. Non-zero exit on internal failure; the host treats stderr
//! as a warning and continues without an injection.
